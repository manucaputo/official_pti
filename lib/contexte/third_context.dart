    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          const Center(child: Text("Application du théorème de Thalès",
              style: TextStyle(
          ...
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text('Elle calcule la longueur de l’ombre du sapin : il fait 10 mètres.',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
          ...
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text('Elle dépose son foulard à 10 mètres de l’arbre, à la pointe de l’ombre.',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
          ...
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text('Elle se place à un mètre du foulard à l’intérieur de l’ombre, soit à 9 mètres du sapin.',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
          ...
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text('Morgane sait que la distance qui sépare le tronc de l’arbre du foulard est 10 fois plus grande que la distance qui la sépare du foulard. Morgane déduit que la taille de l’arbre est 10 fois plus grande que la sienne. Donc : 1,70 m x 10 = 17 m. Sachant que l’arbre se situe à 18 mètres de la mairie, s’il venait à tomber, le sapin s\'écraserait à 1 mètre de la mairie. Grâce à Thalès, Morgane n’a donc pas besoin d\'abattre l\'arbre.',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
