  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          const Center(
            child: Text("Application du théorème de Pythagore",
                style: TextStyle(
          ...
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text(
                  'Le théorème de Pythagore est une formule de géométrie facile à comprendre et très utile dans la vie courante.',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
          ...
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text(
                  'Voici comment l’appliquer de manière simple dans diverses situations.',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
          ...
          Container(
            ...
            child: Image.asset('/images/Contexte2-OK.png', scale: 3),
          ),
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text(
                  'Est-ce qu’une sculpture rectangulaire de 42 m de haut sur 16 m de large peut être levée sous le plafond du Grand Palais qui mesure 45 m ? Pour cela, il faut connaître la longueur de la diagonale de la sculpture. En utilisant le théorème de Pythagore, le calcul est le suivant :',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
          ...
          Container(
              margin: const EdgeInsets.fromLTRB(15.0, 10, 15.0, 2.0),
              child: const Text(
                  'La sculpture passe de justesse sous la plafond du Grand Palais. ',
                  style: TextStyle(
                    color: Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
